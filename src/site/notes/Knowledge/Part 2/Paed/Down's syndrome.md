...
1. Free T21 results from failure of separation of chromosome 21 during gametogenesis, leading to an extra chromosome in every cell.
2. Translocation T21 occurs when there is an extra chromosome 21, or part of chromosome 21, attached to another chromosome. A parent can carry a translocation and transmit it to their child, or translocation can occur de novo during maternal meiosis in a parent with a normal karyotype.
3. Mosaic T21 is caused by an error of cell division that occurs after fertilisation resulting in two cell lineages, one with two copies of chromosome 21, another with an extra copy
...
Patients with T21 develop [[Knowledge/Part 2/Cardiac/Pulmonary hypertension\|pulmonary hypertension]] (PH) to a greater severity and at an earlier age than patients without T21 with similar cardiac lesions
...
- [[Subglottic stenosis\|Subglottic stenosis]]
	...
	- ↑ likelihood of requiring surgical intervention therefore intubation
		- → acquired SGS
- Laryngomalacia
	- high prevalence ∵ generalised hypotonia & high prevalence of [[pages/GORD\|GORD]]

The anatomical features, combined with generalised hypotonia and an increased prevalence of obesity, result in a high prevalence of [[Knowledge/Medicine/obstructive sleep apnoea syndrome\|OSAS]]
